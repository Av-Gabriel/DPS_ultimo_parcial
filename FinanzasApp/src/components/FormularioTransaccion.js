            ...
            <View style={styles.modalOverlay}>
                <View style={styles.modalContainer}>
                    ...
                    <ScrollView>
                        ...
                        <View style={styles.pickerContainer}>
                            <Picker selectedValue={cuenta} onValueChange={setCuenta} style={styles.picker}>
                                <Picker.Item label="-- Seleccione --" value="" />
                                {cuentas.map(c => <Picker.Item key={c.id} label={c.nombre} value={c.nombre} />)}
                            </Picker>
                        </View>
...
const styles = StyleSheet.create({
    ...
    pickerContainer: { borderWidth: 1, borderColor: '#E0E0E0', borderRadius: 10, overflow: 'hidden' },
    picker: { height: 50 },
